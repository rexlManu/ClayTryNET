    ...
    public boolean execute(CommandSender sender, String[] args, String label) {
        ...
        /**String header = ChatColor.DARK_GREEN
                ...
                helpHeader                                                                  // start out with the initial header
                        .replace("#{version}", "v" + plugin.getCityBuild().getDescription().getVersion())                  // fill in the version
                        .replace("#{author}", ChatColor.BLUE + "" + ChatColor.DARK_GREEN)   // fill in the author name
                + " ||--" +
