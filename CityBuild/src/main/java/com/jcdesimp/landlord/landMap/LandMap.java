...
public class LandMap {
    ...
    public LandMap(Player p, Landlord plugin) {
        ...
        }.runTaskTimer(Landlord.getInstance().getCityBuild(), 0L, 7L).getTaskId();
    ...
    public static String[][] getMapDir(String dir) {
        ...
        String[][] mapDir = new String[][]{
                {pixel1, pixel2, pixel2, pfeilee, pixel2, pixel2, pixel1},
                {pixel2, pixel1, pixel2, pfeilee, pixel2, pixel1, pixel2},
                {pixel2, pixel2, pixel1, pfeilee, pixel1, pixel2, pixel2},
                {pixel1, pixel2, pixel1, location, pixel2, pixel1, pixel2},
                {pixel1, pixel1, pixel2, pixel2, pixel2, pixel1, pixel1},
                {pixel1, pixel2, pixel1, pixel1, pixel1, pixel2, pixel1},
                {pixel2, pixel1, pixel1, pixel1, pixel1, pixel1, pixel2}
        };

        if (dir.equals("west")) {
            mapDir = new String[][]{
                    {pixel1, pixel2, pixel2, pixel2, pixel2, pixel2, pixel1},
                    {pixel2, pixel1, pixel2, pixel1, pixel2, pixel1, pixel2},
                    {pixel2, pixel2, pixel1, pixel2, pixel1, pixel2, pixel2},
                    {pfeilee, pfeilee, pfeilee, location, pixel2, pixel1, pixel2},
                    {pixel1, pixel1, pixel2, pixel2, pixel2, pixel1, pixel1},
                    {pixel1, pixel2, pixel1, pixel1, pixel1, pixel2, pixel1},
                    {pixel2, pixel1, pixel1, pixel1, pixel1, pixel1, pixel2}
            };
            ...
            mapDir = new String[][]{
                    {pixel1, pixel2, pixel2, pixel2, pixel2, pixel2, pixel1},
                    {pfeilee, pixel1, pixel2, pixel1, pixel2, pixel1, pixel2},
                    {pixel2, pfeilee, pfeilee, pixel2, pixel1, pixel2, pixel2},
                    {pixel1, pixel2, pixel1, location, pixel2, pixel1, pixel2},
                    {pixel1, pixel1, pixel2, pixel2, pixel2, pixel1, pixel1},
                    {pixel1, pixel2, pixel1, pixel1, pixel1, pixel2, pixel1},
                    {pixel2, pixel1, pixel1, pixel1, pixel1, pixel1, pixel2}
            ...
            mapDir = new String[][]{
                    {pfeilee, pixel2, pixel2, pixel2, pixel2, pixel2, pixel1},
                    {pixel2, pfeilee, pixel2, pixel1, pixel2, pixel1, pixel2},
                    {pixel2, pixel2, pfeilee, pixel2, pixel1, pixel2, pixel2},
                    {pixel1, pixel2, pixel1, location, pixel2, pixel1, pixel2},
                    {pixel1, pixel1, pixel2, pixel2, pixel2, pixel1, pixel1},
                    {pixel1, pixel2, pixel1, pixel1, pixel1, pixel2, pixel1},
                    {pixel2, pixel1, pixel1, pixel1, pixel1, pixel1, pixel2}
            ...
            mapDir = new String[][]{
                    {pixel1, pfeilee, pixel2, pixel2, pixel2, pixel2, pixel1},
                    {pixel2, pixel1, pfeilee, pixel1, pixel2, pixel1, pixel2},
                    {pixel2, pixel2, pfeilee, pixel2, pixel1, pixel2, pixel2},
                    {pixel1, pixel2, pixel1, location, pixel2, pixel1, pixel2},
                    {pixel1, pixel1, pixel2, pixel2, pixel2, pixel1, pixel1},
                    {pixel1, pixel2, pixel1, pixel1, pixel1, pixel2, pixel1},
            ...
            mapDir = new String[][]{
                    {pixel1, pixel2, pixel2, pixel2, pixel2, pfeilee, pixel1},
                    {pixel2, pixel1, pixel2, pixel1, pfeilee, pixel1, pixel2},
                    {pixel2, pixel2, pixel1, pixel2, pfeilee, pixel2, pixel2},
                    {pixel1, pixel2, pixel1, location, pixel2, pixel1, pixel2},
                    {pixel1, pixel1, pixel2, pixel2, pixel2, pixel1, pixel1},
                    {pixel1, pixel2, pixel1, pixel1, pixel1, pixel2, pixel1},
                    {pixel2, pixel1, pixel1, pixel1, pixel1, pixel1, pixel2}
            ...
            mapDir = new String[][]{
                    {pixel1, pixel2, pixel2, pixel2, pixel2, pixel2, pfeilee},
                    {pixel2, pixel1, pixel2, pixel1, pixel2, pfeilee, pixel2},
                    {pixel2, pixel2, pixel1, pixel2, pfeilee, pixel2, pixel2},
                    {pixel1, pixel2, pixel1, location, pixel2, pixel1, pixel2},
                    {pixel1, pixel1, pixel2, pixel2, pixel2, pixel1, pixel1},
                    {pixel1, pixel2, pixel1, pixel1, pixel1, pixel2, pixel1},
            ...
            mapDir = new String[][]{
                    {pixel1, pixel2, pixel2, pixel2, pixel2, pixel2, pixel1},
                    {pixel2, pixel1, pixel2, pixel1, pixel2, pixel1, pfeilee},
                    {pixel2, pixel2, pixel1, pixel2, pfeilee, pfeilee, pixel2},
                    {pixel1, pixel2, pixel1, location, pixel2, pixel1, pixel2},
                    {pixel1, pixel1, pixel2, pixel2, pixel2, pixel1, pixel1},
                    {pixel1, pixel2, pixel1, pixel1, pixel1, pixel2, pixel1},
                    {pixel2, pixel1, pixel1, pixel1, pixel1, pixel1, pixel2}
            ...
            mapDir = new String[][]{
                    ...
                    {pixel2, pixel1, pixel2, pixel1, pixel2, pixel1, pixel2},
                    /**/{pixel2, pixel2, pixel1, pixel2, pixel1, pixel2, pixel2},
                    {pixel1, pixel2, pixel1, location, pfeilee, pfeilee, pfeilee},
                    {pixel1, pixel1, pixel2, pixel2, pixel2, pixel1, pixel1},
                    {pixel1, pixel2, pixel1, pixel1, pixel1, pixel2, pixel1},
                    {pixel2, pixel1, pixel1, pixel1, pixel1, pixel1, pixel2}
            };
            ...
            mapDir = new String[][]{
                    ...
                    {pixel2, pixel2, pixel1, pixel2, pixel1, pixel2, pixel2},
                    {pixel1, pixel2, pixel1, location, pixel2, pixel1, pixel2},
                    {pixel1, pixel1, pixel2, pixel2, pfeilee, pfeilee, pixel1},
                    {pixel1, pixel2, pixel1, pixel1, pixel1, pixel2, pfeilee},
                    {pixel2, pixel1, pixel1, pixel1, pixel1, pixel1, pixel2}
            };
            ...
            mapDir = new String[][]{
                    ...
                    {pixel2, pixel2, pixel1, pixel2, pixel1, pixel2, pixel2},
                    {pixel1, pixel2, pixel1, location, pixel2, pixel1, pixel2},
                    {pixel1, pixel1, pixel2, pixel2, pfeilee, pixel1, pixel1},
                    {pixel1, pixel2, pixel1, pixel1, pixel1, pfeilee, pixel1},
                    {pixel2, pixel1, pixel1, pixel1, pixel1, pixel1, pfeilee}
            };
            ...
            mapDir = new String[][]{
                    ...
                    {pixel1, pixel2, pixel1, location, pixel2, pixel1, pixel2},
                    {pixel1, pixel1, pixel2, pixel2, pfeilee, pixel1, pixel1},
                    {pixel1, pixel2, pixel1, pixel1, pfeilee, pixel2, pixel1},
                    {pixel2, pixel1, pixel1, pixel1, pixel1, pfeilee, pixel2}
            };
            ...
            mapDir = new String[][]{
                    ...
                    {pixel2, pixel2, pixel1, pixel2, pixel1, pixel2, pixel2},
                    {pixel1, pixel2, pixel1, location, pixel2, pixel1, pixel2},
                    {pixel1, pixel1, pixel2, pfeilee, pixel2, pixel1, pixel1},
                    {pixel1, pixel2, pixel1, pfeilee, pixel1, pixel2, pixel1},
                    {pixel2, pixel1, pixel1, pfeilee, pixel1, pixel1, pixel2}
            };
            ...
            mapDir = new String[][]{
                    ...
                    {pixel2, pixel2, pixel1, pixel2, pixel1, pixel2, pixel2},
                    {pixel1, pixel2, pixel1, location, pixel2, pixel1, pixel2},
                    {pixel1, pixel1, pfeilee, pixel2, pixel2, pixel1, pixel1},
                    {pixel1, pixel2, pfeilee, pixel1, pixel1, pixel2, pixel1},
                    {pixel2, pfeilee, pixel1, pixel1, pixel1, pixel1, pixel2}
            };
            ...
            mapDir = new String[][]{
                    ...
                    {pixel1, pixel2, pixel1, location, pixel2, pixel1, pixel2},
                    {pixel1, pixel1, pfeilee, pixel2, pixel2, pixel1, pixel1},
                    {pixel1, pfeilee, pixel1, pixel1, pixel1, pixel2, pixel1},
                    {pfeilee, pixel1, pixel1, pixel1, pixel1, pixel1, pixel2}
            };
            ...
            mapDir = new String[][]{
                    ...
                    {pixel2, pixel2, pixel1, pixel2, pixel1, pixel2, pixel2},
                    {pixel1, pixel2, pixel1, location, pixel2, pixel1, pixel2},
                    {pixel1, pfeilee, pfeilee, pixel2, pixel2, pixel1, pixel1},
                    {pfeilee, pixel2, pixel1, pixel1, pixel1, pixel2, pixel1},
                    {pixel2, pixel1, pixel1, pixel1, pixel1, pixel1, pixel2}
            };
        }
    ...
    private Scoreboard displayMap(Player p) {
        ...
        //Landlord.getInstance().getCityBuild().getPlayerScoreboard().updatePlayTablist(p);
        ...
        objective.setDisplayName("§8» §2§lC§alayTry §8┃ §7Map");
    ...
    private String[] buildMap(Player p) {
        ...
        //⬛⬜✦
        mapRows[mapRows.length - 3] = "§a⬛ §8» §7Deine";
        mapRows[mapRows.length - 2] = "§e⬛ §8» §7Freunde";
        mapRows[mapRows.length - 1] = "§c⬛ §8» §7Fremde";
        return mapRows;
    }
